...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-gray-100 flex flex-col relative bg-gradient-radial">
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-50 glass-nav border-t border-white/10 p-2 flex justify-around items-center bg-[#0B0F19]/90 backdrop-blur-xl">
        <button
          onClick={() => { setSelectedCampaignId(null); setActiveTab('feed'); }}
          className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all ${activeTab === 'feed' ? 'text-teal-400' : 'text-gray-500 hover:text-gray-300'}`}
        >
        ...
        <button
          onClick={() => { setSelectedCampaignId(null); setActiveTab('create'); }}
          className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all ${activeTab === 'create' ? 'text-teal-400' : 'text-gray-500 hover:text-gray-300'}`}
        >
        ...
        <button
          onClick={() => { setSelectedCampaignId(null); setActiveTab('dashboard'); }}
          className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all ${activeTab === 'dashboard' ? 'text-teal-400' : 'text-gray-500 hover:text-gray-300'}`}
        >
