                ...
                return (
                  <div key={m.milestone_id} className="p-4 bg-white/5 border border-white/5 rounded-xl space-y-3">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        <h3 className="text-sm font-bold text-white mb-0.5"><span className="text-gray-400 mr-2">M{index + 1}</span> {m.title}</h3>
                        <p className="text-xs text-blue-400 font-semibold">{m.amount.toLocaleString()} XLM</p>
                      </div>
