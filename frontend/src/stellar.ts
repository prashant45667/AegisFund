...
import contractData from './contract_address.json';
const CONTRACT_ID = contractData.contract_address || 'CAPMFGM37EVDPEYZNMNNJW7OB2Y4GZY54RPNMOAHMWQWGFR7GPRYHHSY';
...
export const StellarService = {
  ...
  createCampaign: async (
    ...
    try {
      ...
      localStorage.setItem(`aegisfund_meta_${nextId}`, JSON.stringify({ title, description, category }));
